...
export interface ApiContractRegistryEntry {
  readonly id: string;
}

export function validateApiContractRegistryCoverage(input: {
  readonly apiRoot: string;
  readonly contractExports: Record<string, ApiContractRegistryEntry>;
  readonly registryContracts: readonly ApiContractRegistryEntry[];
}): string[] {
