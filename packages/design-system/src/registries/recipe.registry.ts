  ...
  recipes: [
    {
      ...
      declarations: [
        { property: "font-size",    token: "afenda.typography.font-size.label.md" },
        { property: "line-height",  token: "afenda.typography.line-height.label.md" },
        { property: "font-weight",  token: "afenda.typography.font-weight.label.md" },
    ...
    },
    {
      ...
      declarations: [
        ...
        { property: "foreground",   token: "afenda.status-tone.neutral.foreground" },
        ...
        { property: "font-weight",  token: "afenda.typography.font-weight.body.sm" },
