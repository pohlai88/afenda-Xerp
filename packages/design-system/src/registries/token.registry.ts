...
const tokens: readonly TokenDefinition[] = [
  ...
  ...section("color", "SEMANTIC · Action & overlay", [
    ...
    ["afenda.semantic.action.primary.surface", "var(--afenda-color-primary-subtle)", null, "Primary action surface."],
  ...
  ...section("color", "SEMANTIC · Table", [
    ["afenda.table.header.background", "var(--afenda-color-surface-muted)", null, "ERP data-grid header background."],
    ["afenda.table.header.foreground", "var(--afenda-color-text-muted)", null, "ERP data-grid header text."],
    ["afenda.table.row.background", "var(--afenda-color-surface-card)", null, "Data-grid row background."],
    ["afenda.table.row.hover", "var(--afenda-color-surface-hover)", null, "Data-grid row hover."],
    ["afenda.table.row.selected", "var(--afenda-color-surface-selected)", null, "Data-grid row selected."],
    ["afenda.table.row.border", "var(--afenda-color-border-muted)", null, "Data-grid row separator."],
    ["afenda.table.cell.muted", "var(--afenda-color-text-subtle)", null, "De-emphasised cell text."],
    ["afenda.table.cell.numeric", "var(--afenda-color-text-default)", null, "Numeric cell text (tabular)."],
  ]),
  ...section("color", "SEMANTIC · Form field", [
    ["afenda.form-field.background", "var(--afenda-color-surface-card)", null, "Input / select / textarea background."],
    ["afenda.form-field.border", "var(--afenda-color-input)", null, "Form field border."],
    ["afenda.form-field.border.focus", "var(--afenda-color-border-focus)", null, "Form field focused border."],
    ["afenda.form-field.placeholder", "var(--afenda-color-text-placeholder)", null, "Form field placeholder text."],
    ["afenda.form-field.disabled.background", "var(--afenda-state-disabled-surface)", null, "Disabled form field background."],
    ["afenda.form-field.invalid.border", "var(--afenda-status-tone-invalid-border)", null, "Invalid form field border."],
  ]),
