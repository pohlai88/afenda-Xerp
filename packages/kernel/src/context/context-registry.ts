...
export const KERNEL_OPERATING_CONTEXT_SUPPORT_MODULES = [
  ...
  "hierarchy-id-boundary.assert.ts",
  "hierarchy-id-boundary.parser.ts",
  "localization-context.contract.ts",
  "localization-context.assert.ts",
  "localization-context.parser.ts",
  "rounding-mode.contract.ts",
  "rounding-mode.assert.ts",
  "rounding-mode.parser.ts",
  "decimal-precision.contract.ts",
  "decimal-precision.assert.ts",
  "decimal-precision.parser.ts",
  ...
  "permission-scope-context.projection.ts",
