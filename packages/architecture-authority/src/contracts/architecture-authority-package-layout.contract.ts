...
export const ARCHITECTURE_AUTHORITY_PACKAGE_TARGET_PATHS = [
  ...
  "packages/architecture-authority/src/contracts/architecture-governance-amendment.contract.ts",
  ...
  "packages/architecture-authority/src/validators/validate-architecture-governance-amendment.ts",
