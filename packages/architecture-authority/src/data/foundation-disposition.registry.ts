...
export const FOUNDATION_DISPOSITION_FINGERPRINT =
  "FOUNDATION-DISPOSITION-2026-07-06-v43" as const;
...
const foundationDispositionEntries = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "apps/erp/src/components/procurement/procurement-requisitions-composer.client.tsx",
      "apps/erp/src/components/procurement/procurement-purchase-orders-composer.client.tsx",
      "packages/shadcn-studio-v2/docs/slices/LANE-B-08-ERP-SURFACE-WAVE-METADATA-PROCUREMENT.md",
  ...
  },
  {
    ...
    evidence: [
      ...
      "packages/shadcn-studio-v2/src/storybook/lab.ts",
      "packages/shadcn-studio-v2/docs/slices/LANE-B-11-STORYBOOK-V2-ALIGNMENT.md",
  ...
  },
  {
    ...
    evidence: [
      ...
      "packages/shadcn-studio-v2/docs/MIGRATION-MAP.md",
      "packages/shadcn-studio-v2/docs/slices/LANE-B-15-V1-FORMAL-DEPRECATION-SIGN-OFF.md",
      "packages/shadcn-studio-v2/src/__tests__/lane-b-sign-off.test.ts",
      "packages/architecture-authority/src/data/package-registry.data.ts",
    ],
    knownGaps: [],
    allowedAgents: ["foundation-registry-owner"],
    prohibited: [
      "do-not-restore-v1-as-active-presentation-owner",
      "do-not-import-shadcn-studio-v1-in-consumers",
      "do-not-run-ui-guard",
      "do-not-add-v1-consumer-imports",
    ],
    gates: ["pnpm check:foundation-disposition"],
    legacyTipEvidence: [],
  },
  {
    id: "PKGR05C_SHADCN_STUDIO_V2",
    packageId: "PKG-030",
    packageName: "@afenda/shadcn-studio-v2",
    domain: "shadcn-studio-presentation-v2",
    lane: "green-lane",
    runtimeOwner: "packages/shadcn-studio-v2",
    authority: "PAS-006",
    requiredBeforeAccounting: false,
    evidence: [
      "docs/adr/ADR-0040-promote-shadcn-studio-v2-and-deprecate-legacy.md",
      ...
      "packages/shadcn-studio-v2/docs/MIGRATION-MAP.md",
      "packages/shadcn-studio-v2/docs/slices/LANE-B-V1-MIGRATION-AND-RETIREMENT-INDEX.md",
      "packages/shadcn-studio-v2/package.json",
    ...
    prohibited: [
      ...
      "do-not-import-shadcn-studio-v1",
      "do-not-run-ui-guard",
    ],
    gates: [
      "pnpm --filter @afenda/shadcn-studio-v2 test:run",
