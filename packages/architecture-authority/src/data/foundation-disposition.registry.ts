...
const foundationDispositionEntries = [
  ...
  },
  {
    ...
    lane: "green-lane",
    runtimeOwner: "packages/ui-composition",
    authority: "ADR-0014",
    requiredBeforeAccounting: true,
    evidence: [
      "packages/ui-composition/src/metadata.contract.ts",
      "packages/ui-composition/src/surface.contract.ts",
      "packages/ui-composition/src/section.contract.ts",
      "packages/ui-composition/src/action.contract.ts",
      "packages/ui-composition/src/governance/cross-package-authority.contract.ts",
      "packages/ui-composition/src/governance/metadata-authority-map.contract.ts",
      "packages/ui-composition/src/__tests__/no-implementation-leakage.test.ts",
      "packages/ui-composition/src/__tests__/cross-package-authority.test.ts",
      "packages/ui-composition/src/metadata.version.ts",
    ],
    knownGaps: [],
  ...
  },
  {
    ...
    evidence: [
      ...
      "docs/PAS/slice/b38-pas002a-kernel-boundary-gate.md",
      "docs/PAS/slice/b39-pas002a-ownership-signoff.md",
      "docs/PAS/slice/b40-pas002a-governance-consumer-proof.md",
      "docs/PAS/slice/b41-pas002a-disposition-completeness.md",
  ...
  },
  {
    ...
    lane: "amber-lane",
    runtimeOwner: "packages/css-authority",
    authority: "PAS-005",
    requiredBeforeAccounting: false,
    evidence: [
      ...
      "packages/css-authority/src/__tests__/architecture-boundary.test.ts",
      ".cursor/skills/css-authority/SKILL.md",
      "scripts/governance/check-css-authority-conformance.mts",
      "packages/architecture-authority/src/data/package-registry.data.ts",
      "packages/architecture-authority/src/data/layer-registry.data.ts",
      "packages/architecture-authority/src/data/ownership-registry.data.ts",
      "packages/architecture-authority/src/data/dependency-registry.data.ts",
  ...
  },
  {
    ...
    evidence: [
      ...
      "packages/appshell/src/presentation/wrappers/presentation-mcp-wrapper.registry.ts",
      "packages/appshell/src/__tests__/presentation-mcp-wrapper.registry.test.ts",
      "packages/appshell/src/styles/afenda-appshell-studio.css",
      "packages/appshell/src/__tests__/css-manifest.test.ts",
      ".cursor/skills/shadcn-studio-authority/SKILL.md",
      "docs/PAS/slice/b38-pas005a-scaffold.md",
      ...
      "docs/PAS/slice/b42h-pas005a-legacy-tree-delete.md",
      "docs/PAS/slice/b42i-pas005a-mcp-wrapper-strangler.md",
      "docs/PAS/slice/b42j-pas005a-wrapper-expansion-delegating-flip.md",
      "docs/PAS/slice/b42k-pas005a-statistics-a11y-delegating-flip.md",
      "docs/PAS/slice/b42l-pas005a-studio-css-consolidation.md",
      "packages/architecture-authority/src/data/package-registry.data.ts",
      "packages/architecture-authority/src/data/layer-registry.data.ts",
      "packages/architecture-authority/src/data/ownership-registry.data.ts",
      "packages/architecture-authority/src/data/dependency-registry.data.ts",
    ...
    prohibited: [
      ...
      "do-not-migrate-appshell-studio-tsx",
