...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Daily orders line trend — dual series legend, tabular-nums metric values.",
      },
    },
  },
};

export const GrossRevenue: Story = {
  args: resolveLineTrendsCard("Gross revenue"),
  parameters: {
    docs: {
      description: {
        story:
          "Gross revenue comparison card with larger magnitude series values.",
      },
    },
  },
};
