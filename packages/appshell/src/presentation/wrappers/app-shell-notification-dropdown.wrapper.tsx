...
function GovernedAppShellNotificationDropdown({
  trigger,
  defaultOpen,
  align = "end",
...
export const AppShellNotificationDropdown = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedAppShellNotificationDropdown,
});
