...
function GovernedAppShellProfileDropdown({
  trigger,
  defaultOpen,
  align = "end",
...
export const AppShellProfileDropdown = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedAppShellProfileDropdown,
});
