...
function GovernedAppShellSidebarUserDropdown({
...
export const AppShellSidebarUserDropdown = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedAppShellSidebarUserDropdown,
});
