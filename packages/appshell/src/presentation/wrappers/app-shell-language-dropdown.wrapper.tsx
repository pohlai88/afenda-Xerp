...
function GovernedAppShellLanguageDropdown({
  defaultOpen,
  align = "end",
  trigger,
...
export const AppShellLanguageDropdown = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedAppShellLanguageDropdown,
});
