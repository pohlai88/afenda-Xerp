...
function GovernedAppShellDashboardKpiStat({
  title,
  badge,
  value,
  changePercentage,
...
export const AppShellDashboardKpiStat = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedAppShellDashboardKpiStat,
});
