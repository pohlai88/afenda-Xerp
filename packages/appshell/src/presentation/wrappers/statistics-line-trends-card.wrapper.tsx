...
function GovernedStatisticsLineTrendsCard({
  title,
  series,
  data,
...
export const StatisticsLineTrendsCard = createPresentationMcpWrapper({
  status: "governed-compose",
  GovernedComponent: GovernedStatisticsLineTrendsCard,
});
