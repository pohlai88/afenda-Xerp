...
export const PRESENTATION_MCP_WRAPPER_REGISTRY = [
  ...
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/shell/context-switcher.wrapper.tsx`,
  },
  {
    publicExportName: "AppShellModuleWorkspaceChrome",
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/shell/module-workspace-chrome.wrapper.tsx`,
  },
  {
  ...
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-01.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-02.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-03.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-04.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-05.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-06.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/account-settings/shell/app-shell-account-settings-07.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/auth/login-page-04.wrapper.tsx`,
  },
  {
    ...
    status: "afenda-only",
    wrapperPath: `${WRAPPER_ROOT}/auth/error-page-02.wrapper.tsx`,
  },
  {
    ...
    status: "delegating",
    wrapperPath: `${WRAPPER_ROOT}/marketing/hero-section-01.wrapper.tsx`,
  },
  {
    ...
    status: "delegating",
    wrapperPath: `${WRAPPER_ROOT}/statistics/orders-progress-card.wrapper.tsx`,
  },
  {
    ...
    status: "delegating",
    wrapperPath: `${WRAPPER_ROOT}/statistics/sales-overview-card.wrapper.tsx`,
  },
  {
    ...
    status: "delegating",
    wrapperPath: `${WRAPPER_ROOT}/dashboard/chart-earning-report.wrapper.tsx`,
  },
