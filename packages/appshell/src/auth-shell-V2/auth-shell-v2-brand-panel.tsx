...
import {
  ...
  AUTH_SHELL_V2_BRAND_PRODUCT_LABEL,
  AUTH_SHELL_V2_BRAND_SUPPORTING_TEXT,
} from "./auth-shell-v2.constants.js";
import type { AuthShellBrandPanelProps } from "./auth-shell-v2.types.js";
...
export function AuthShellBrandPanel({
  ...
  productLabel = AUTH_SHELL_V2_BRAND_PRODUCT_LABEL,
  ...
  return (
    <aside
      ...
      style={
        brandColor
          ? ({ "--af-auth-v2-brand": brandColor } as CSSProperties)
          : undefined
      }
    >
