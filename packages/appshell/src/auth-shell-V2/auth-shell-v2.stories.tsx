...
import { AuthShellBrandPanel } from "./auth-shell-v2-brand-panel.js";
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Isolated AUTH-SHELL-V2 chrome for `(auth-v2)` /v2/* routes. Form logic stays in apps/erp.",
      },
    },
  },
} satisfies Meta;
...
function SampleAuthV2Form() {
  return (
    <form className="erp-auth-v2-form">
      <div>
        <Label htmlFor="story-auth-v2-email">Email</Label>
        <Input
          autoComplete="email"
          id="story-auth-v2-email"
          name="email"
          type="email"
        />
      </div>
      <div>
        <Label htmlFor="story-auth-v2-password">Password</Label>
        <Input
          autoComplete="current-password"
          id="story-auth-v2-password"
          name="password"
          type="password"
        />
      </div>
...
export const AccessSignIn: Story = {
  render: () => (
    <AuthShellEntryPage
      ...
      lane="access"
      title={AUTH_SHELL_V2_ENTRY_DEFAULT_HEADING}
    >
      <SampleAuthV2Form />
    </AuthShellEntryPage>
  ),
...
export const TenantBrandedSignIn: Story = {
  render: () => (
    <AuthShellEntryPage
      ...
      eyebrow={AUTH_SHELL_V2_ENTRY_DEFAULT_EYEBROW}
      lane="access"
      shellStyle={{ "--af-auth-v2-brand": "#1f4d36" } as CSSProperties}
      title={AUTH_SHELL_V2_ENTRY_DEFAULT_HEADING}
      visual={
        <AuthShellVisualPanel>
          <AuthShellBrandPanel
