...
export function AuthShell({
  ...
  const rootClassName = ["af-auth-shell", "app-shell-root", className]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    ...
    >
      ...
      {footer === undefined ? null : (
        <div className="af-auth-shell__shell-footer" data-auth-slot="footer">
          {footer}
        </div>
      )}
    </div>
...
export { AuthShellBrandPanel } from "./auth-shell-v2-brand-panel.js";
