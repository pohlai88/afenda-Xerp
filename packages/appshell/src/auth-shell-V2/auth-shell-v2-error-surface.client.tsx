...
import {
  AUTH_SHELL_V2_ERROR_DEFAULT_EYEBROW,
  AUTH_SHELL_V2_ERROR_DEFAULT_RETRY_LABEL,
} from "./auth-shell-v2.constants.js";
import type { AuthShellErrorSurfaceProps } from "./auth-shell-v2.types.js";
...
export function AuthShellErrorSurfaceWithRetry({
  isRetrying = false,
  onRetry,
  retryLabel = AUTH_SHELL_V2_ERROR_DEFAULT_RETRY_LABEL,
  actions,
  ...surfaceProps
