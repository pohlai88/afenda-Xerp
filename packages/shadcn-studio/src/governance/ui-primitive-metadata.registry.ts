/**
 * PAS-006 Slot C — aggregated metadata payloads for all governed UI primitives.
 * 28 Base UI widgets + 41 composition components (69 total).
 */
...
export const UI_PRIMITIVE_METADATA_BY_ID: Record<
  string,
  UiPrimitiveMetadataPayload
> = Object.fromEntries(
