...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `${shadcnStudioPrimitivesDocs.component} Variant matrix catalog — for args/play smoke tests see colocated stories under each primitive (tag: colocated).`,
      },
    },
