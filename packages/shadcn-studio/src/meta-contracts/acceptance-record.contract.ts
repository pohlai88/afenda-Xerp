 ...
 * Role: Acceptance record wire + ACPA seal field guards
 * Family: acceptance-record · flat L1 wire
 * Relies on: block-lifecycle.contract, wire-guard.helpers
 * Relied on by: acceptance-record.validator, index barrel
