...
<Meta title="Shadcn Studio/Promotion/statistics-total-revenue-card" />

# statistics-total-revenue-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-total-revenue-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsTotalRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsTotalRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-total-revenue-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsTotalRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
