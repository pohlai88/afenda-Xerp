...
<Meta title="Shadcn Studio/Promotion/chart-project-financial-status" />

# chart-project-financial-status — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-project-financial-status` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartProjectFinancialStatus (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartProjectFinancialStatus (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-project-financial-status` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartProjectFinancialStatus (curated — add to shadcn-studio-blocks.stories.tsx)` |
