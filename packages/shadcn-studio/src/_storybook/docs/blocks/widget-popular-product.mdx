...
<Meta title="Shadcn Studio/Promotion/widget-popular-product" />

# widget-popular-product — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-popular-product` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetPopularProduct (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetPopularProduct (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-popular-product` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetPopularProduct (curated — add to shadcn-studio-blocks.stories.tsx)` |
