...
<Meta title="Shadcn Studio/Promotion/account-settings-07" />

# account-settings-07 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-07` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings07` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings07`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings07` |
