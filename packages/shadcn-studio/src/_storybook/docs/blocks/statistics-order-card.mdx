...
<Meta title="Shadcn Studio/Promotion/statistics-order-card" />

# statistics-order-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-order-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsOrderCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsOrderCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-order-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsOrderCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
