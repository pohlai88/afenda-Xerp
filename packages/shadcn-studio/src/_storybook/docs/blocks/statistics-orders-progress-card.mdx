...
<Meta title="Shadcn Studio/Promotion/statistics-orders-progress-card" />

# statistics-orders-progress-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-orders-progress-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsOrdersProgressCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsOrdersProgressCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsOrdersProgressCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
