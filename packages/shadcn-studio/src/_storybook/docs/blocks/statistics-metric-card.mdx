...
<Meta title="Shadcn Studio/Promotion/statistics-metric-card" />

# statistics-metric-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-metric-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsMetricCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsMetricCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-metric-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsMetricCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
