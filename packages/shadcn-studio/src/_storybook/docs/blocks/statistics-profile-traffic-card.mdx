...
<Meta title="Shadcn Studio/Promotion/statistics-profile-traffic-card" />

# statistics-profile-traffic-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-profile-traffic-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsProfileTrafficCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsProfileTrafficCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsProfileTrafficCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
