...
<Meta title="Shadcn Studio/Promotion/statistics-profit-card" />

# statistics-profit-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-profit-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-profit-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
