...
<Meta title="Shadcn Studio/Promotion/hero-section-01" />

# hero-section-01 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `hero-section-01` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/HeroSection01` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/HeroSection01`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/HeroSection01` |
