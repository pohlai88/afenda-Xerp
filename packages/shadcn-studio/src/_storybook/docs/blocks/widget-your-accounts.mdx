...
<Meta title="Shadcn Studio/Promotion/widget-your-accounts" />

# widget-your-accounts — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-your-accounts` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetYourAccounts (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetYourAccounts (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-your-accounts` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetYourAccounts (curated — add to shadcn-studio-blocks.stories.tsx)` |
