...
<Meta title="Shadcn Studio/Promotion/statistics-line-trends-card" />

# statistics-line-trends-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-line-trends-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsLineTrendsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsLineTrendsCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsLineTrendsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
