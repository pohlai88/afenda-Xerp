...
<Meta title="Shadcn Studio/Promotion/chart-finance" />

# chart-finance — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-finance` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartFinance (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartFinance (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-finance` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartFinance (curated — add to shadcn-studio-blocks.stories.tsx)` |
