...
<Meta title="Shadcn Studio/Promotion/statistics-with-status" />

# statistics-with-status — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-with-status` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsWithStatus (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsWithStatus (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-with-status` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsWithStatus (curated — add to shadcn-studio-blocks.stories.tsx)` |
