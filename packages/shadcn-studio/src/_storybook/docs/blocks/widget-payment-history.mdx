...
<Meta title="Shadcn Studio/Promotion/widget-payment-history" />

# widget-payment-history — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-payment-history` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetPaymentHistory (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetPaymentHistory (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetPaymentHistory (curated — add to shadcn-studio-blocks.stories.tsx)` |
