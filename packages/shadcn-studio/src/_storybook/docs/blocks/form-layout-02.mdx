...
<Meta title="Shadcn Studio/Promotion/form-layout-02" />

# form-layout-02 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `form-layout-02` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/FormLayout02` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/FormLayout02`)
...
| `blockId` | `form-layout-02` |
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/FormLayout02` |
