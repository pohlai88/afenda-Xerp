...
<Meta title="Shadcn Studio/Promotion/statistics-sales-growth-card" />

# statistics-sales-growth-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-sales-growth-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsSalesGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsSalesGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-sales-growth-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsSalesGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
