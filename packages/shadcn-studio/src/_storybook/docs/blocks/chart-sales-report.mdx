...
<Meta title="Shadcn Studio/Promotion/chart-sales-report" />

# chart-sales-report — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-sales-report` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartSalesReport (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartSalesReport (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-sales-report` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartSalesReport (curated — add to shadcn-studio-blocks.stories.tsx)` |
