...
<Meta title="Shadcn Studio/Promotion/statistics-trend-card" />

# statistics-trend-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-trend-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsTrendCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsTrendCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsTrendCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
