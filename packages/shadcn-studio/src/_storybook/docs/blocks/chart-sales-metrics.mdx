...
<Meta title="Shadcn Studio/Promotion/chart-sales-metrics" />

# chart-sales-metrics — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-sales-metrics` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartSalesMetrics (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartSalesMetrics (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartSalesMetrics (curated — add to shadcn-studio-blocks.stories.tsx)` |
