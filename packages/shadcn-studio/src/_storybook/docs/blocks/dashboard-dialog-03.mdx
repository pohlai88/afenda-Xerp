...
<Meta title="Shadcn Studio/Promotion/dashboard-dialog-03" />

# dashboard-dialog-03 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dashboard-dialog-03` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DashboardDialog03 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DashboardDialog03 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DashboardDialog03 (curated — add to shadcn-studio-blocks.stories.tsx)` |
