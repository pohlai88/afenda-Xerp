...
<Meta title="Shadcn Studio/Promotion/widget-total-earning" />

# widget-total-earning — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-total-earning` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)` |
