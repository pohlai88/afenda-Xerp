...
<Meta title="Shadcn Studio/Promotion/statistics-impression-card" />

# statistics-impression-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-impression-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsImpressionCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsImpressionCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-impression-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsImpressionCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
