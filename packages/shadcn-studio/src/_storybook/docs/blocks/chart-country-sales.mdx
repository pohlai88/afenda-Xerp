...
<Meta title="Shadcn Studio/Promotion/chart-country-sales" />

# chart-country-sales — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-country-sales` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartCountrySales (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartCountrySales (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-country-sales` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartCountrySales (curated — add to shadcn-studio-blocks.stories.tsx)` |
