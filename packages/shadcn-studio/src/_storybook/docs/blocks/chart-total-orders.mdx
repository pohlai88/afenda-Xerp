...
<Meta title="Shadcn Studio/Promotion/chart-total-orders" />

# chart-total-orders — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-total-orders` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartTotalOrders (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartTotalOrders (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-total-orders` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartTotalOrders (curated — add to shadcn-studio-blocks.stories.tsx)` |
