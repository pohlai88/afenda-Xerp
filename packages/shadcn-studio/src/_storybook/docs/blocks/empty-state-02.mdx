...
<Meta title="Shadcn Studio/Promotion/empty-state-02" />

# empty-state-02 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `empty-state-02` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/EmptyState02` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/EmptyState02`)
...
| `blockId` | `empty-state-02` |
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/EmptyState02` |
