...
<Meta title="Shadcn Studio/Promotion/account-settings-05" />

# account-settings-05 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-05` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings05` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings05`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings05` |
