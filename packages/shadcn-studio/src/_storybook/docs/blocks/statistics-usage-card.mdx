...
<Meta title="Shadcn Studio/Promotion/statistics-usage-card" />

# statistics-usage-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-usage-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsUsageCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsUsageCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-usage-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsUsageCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
