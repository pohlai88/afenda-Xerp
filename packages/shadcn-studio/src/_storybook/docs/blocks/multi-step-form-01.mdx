...
<Meta title="Shadcn Studio/Promotion/multi-step-form-01" />

# multi-step-form-01 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `multi-step-form-01` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/MultiStepForm01 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/MultiStepForm01 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `multi-step-form-01` |
| `presentationLabProof` | `Shadcn Studio/Blocks/MultiStepForm01 (curated — add to shadcn-studio-blocks.stories.tsx)` |
