...
<Meta title="Shadcn Studio/Promotion/statistics-income-card" />

# statistics-income-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-income-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsIncomeCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsIncomeCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsIncomeCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
