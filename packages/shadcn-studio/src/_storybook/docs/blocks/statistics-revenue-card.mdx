...
<Meta title="Shadcn Studio/Promotion/statistics-revenue-card" />

# statistics-revenue-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-revenue-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsRevenueCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
