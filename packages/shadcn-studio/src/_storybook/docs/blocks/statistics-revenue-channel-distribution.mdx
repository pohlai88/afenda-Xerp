...
<Meta title="Shadcn Studio/Promotion/statistics-revenue-channel-distribution" />

# statistics-revenue-channel-distribution — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-revenue-channel-distribution` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsRevenueChannelDistribution (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsRevenueChannelDistribution (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-revenue-channel-distribution` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsRevenueChannelDistribution (curated — add to shadcn-studio-blocks.stories.tsx)` |
