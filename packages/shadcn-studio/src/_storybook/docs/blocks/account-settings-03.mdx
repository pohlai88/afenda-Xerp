...
<Meta title="Shadcn Studio/Promotion/account-settings-03" />

# account-settings-03 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-03` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings03` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings03`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings03` |
