...
<Meta title="Shadcn Studio/Promotion/account-settings-06" />

# account-settings-06 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-06` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings06` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings06`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings06` |
