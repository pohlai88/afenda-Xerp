...
<Meta title="Shadcn Studio/Promotion/widget-top-products" />

# widget-top-products — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-top-products` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetTopProducts (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetTopProducts (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-top-products` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetTopProducts (curated — add to shadcn-studio-blocks.stories.tsx)` |
