...
<Meta title="Shadcn Studio/Promotion/dialog-search" />

# dialog-search — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dialog-search` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DialogSearch (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DialogSearch (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DialogSearch (curated — add to shadcn-studio-blocks.stories.tsx)` |
