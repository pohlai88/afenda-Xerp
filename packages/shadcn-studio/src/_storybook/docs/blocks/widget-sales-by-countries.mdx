...
<Meta title="Shadcn Studio/Promotion/widget-sales-by-countries" />

# widget-sales-by-countries — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-sales-by-countries` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetSalesByCountries (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetSalesByCountries (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetSalesByCountries (curated — add to shadcn-studio-blocks.stories.tsx)` |
