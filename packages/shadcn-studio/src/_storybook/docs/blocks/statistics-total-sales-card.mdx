...
<Meta title="Shadcn Studio/Promotion/statistics-total-sales-card" />

# statistics-total-sales-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-total-sales-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsTotalSalesCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsTotalSalesCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-total-sales-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsTotalSalesCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
