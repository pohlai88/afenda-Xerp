...
<Meta title="Shadcn Studio/Promotion/dropdown-notification" />

# dropdown-notification — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dropdown-notification` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DropdownNotification (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DropdownNotification (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DropdownNotification (curated — add to shadcn-studio-blocks.stories.tsx)` |
