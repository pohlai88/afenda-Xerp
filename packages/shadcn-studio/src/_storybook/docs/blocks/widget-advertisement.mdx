...
<Meta title="Shadcn Studio/Promotion/widget-advertisement" />

# widget-advertisement — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-advertisement` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetAdvertisement (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetAdvertisement (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-advertisement` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetAdvertisement (curated — add to shadcn-studio-blocks.stories.tsx)` |
