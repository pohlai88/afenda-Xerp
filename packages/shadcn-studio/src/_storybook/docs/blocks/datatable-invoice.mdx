...
<Meta title="Shadcn Studio/Promotion/datatable-invoice" />

# datatable-invoice — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `datatable-invoice` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DatatableInvoice (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DatatableInvoice (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DatatableInvoice (curated — add to shadcn-studio-blocks.stories.tsx)` |
