...
<Meta title="Shadcn Studio/Promotion/statistics-latency-card" />

# statistics-latency-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-latency-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsLatencyCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsLatencyCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-latency-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsLatencyCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
