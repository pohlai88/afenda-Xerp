...
<Meta title="Shadcn Studio/Promotion/account-settings-04" />

# account-settings-04 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-04` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings04` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings04`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings04` |
