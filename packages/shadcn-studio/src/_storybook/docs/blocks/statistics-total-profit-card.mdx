...
<Meta title="Shadcn Studio/Promotion/statistics-total-profit-card" />

# statistics-total-profit-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-total-profit-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsTotalProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsTotalProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-total-profit-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsTotalProfitCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
