...
<Meta title="Shadcn Studio/Promotion/chart-earning-report" />

# chart-earning-report — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-earning-report` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartEarningReport (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartEarningReport (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartEarningReport (curated — add to shadcn-studio-blocks.stories.tsx)` |
