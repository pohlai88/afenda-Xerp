...
<Meta title="Shadcn Studio/Promotion/widget-component-20" />

# widget-component-20 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-component-20` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetComponent20 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetComponent20 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-component-20` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetComponent20 (curated — add to shadcn-studio-blocks.stories.tsx)` |
