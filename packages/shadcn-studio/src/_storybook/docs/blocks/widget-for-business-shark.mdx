...
<Meta title="Shadcn Studio/Promotion/widget-for-business-shark" />

# widget-for-business-shark — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-for-business-shark` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetForBusinessShark (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetForBusinessShark (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-for-business-shark` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetForBusinessShark (curated — add to shadcn-studio-blocks.stories.tsx)` |
