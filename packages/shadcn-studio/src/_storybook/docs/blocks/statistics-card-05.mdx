...
<Meta title="Shadcn Studio/Promotion/statistics-card-05" />

# statistics-card-05 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-card-05` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCard05 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCard05 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-card-05` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCard05 (curated — add to shadcn-studio-blocks.stories.tsx)` |
