...
<Meta title="Shadcn Studio/Promotion/widget-social-network-visits" />

# widget-social-network-visits — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-social-network-visits` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetSocialNetworkVisits (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetSocialNetworkVisits (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-social-network-visits` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetSocialNetworkVisits (curated — add to shadcn-studio-blocks.stories.tsx)` |
