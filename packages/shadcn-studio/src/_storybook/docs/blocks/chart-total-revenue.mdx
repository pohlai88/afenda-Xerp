...
<Meta title="Shadcn Studio/Promotion/chart-total-revenue" />

# chart-total-revenue — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-total-revenue` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartTotalRevenue (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartTotalRevenue (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartTotalRevenue (curated — add to shadcn-studio-blocks.stories.tsx)` |
