...
<Meta title="Shadcn Studio/Promotion/menu-trigger" />

# menu-trigger — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `menu-trigger` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/MenuTrigger (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/MenuTrigger (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/MenuTrigger (curated — add to shadcn-studio-blocks.stories.tsx)` |
