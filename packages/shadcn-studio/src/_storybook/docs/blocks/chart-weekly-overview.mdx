...
<Meta title="Shadcn Studio/Promotion/chart-weekly-overview" />

# chart-weekly-overview — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-weekly-overview` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartWeeklyOverview (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartWeeklyOverview (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-weekly-overview` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartWeeklyOverview (curated — add to shadcn-studio-blocks.stories.tsx)` |
