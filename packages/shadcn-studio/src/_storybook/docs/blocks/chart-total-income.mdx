...
<Meta title="Shadcn Studio/Promotion/chart-total-income" />

# chart-total-income — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-total-income` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartTotalIncome (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartTotalIncome (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-total-income` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartTotalIncome (curated — add to shadcn-studio-blocks.stories.tsx)` |
