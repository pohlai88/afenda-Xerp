...
<Meta title="Shadcn Studio/Promotion/statistics-category-card" />

# statistics-category-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-category-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCategoryCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCategoryCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-category-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCategoryCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
