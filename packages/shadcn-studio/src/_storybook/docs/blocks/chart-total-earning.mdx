...
<Meta title="Shadcn Studio/Promotion/chart-total-earning" />

# chart-total-earning — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-total-earning` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-total-earning` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartTotalEarning (curated — add to shadcn-studio-blocks.stories.tsx)` |
