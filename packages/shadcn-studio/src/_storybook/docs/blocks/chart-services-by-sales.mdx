...
<Meta title="Shadcn Studio/Promotion/chart-services-by-sales" />

# chart-services-by-sales — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-services-by-sales` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartServicesBySales (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartServicesBySales (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-services-by-sales` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartServicesBySales (curated — add to shadcn-studio-blocks.stories.tsx)` |
