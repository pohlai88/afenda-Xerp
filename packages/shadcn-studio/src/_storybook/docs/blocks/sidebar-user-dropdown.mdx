...
<Meta title="Shadcn Studio/Promotion/sidebar-user-dropdown" />

# sidebar-user-dropdown — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `sidebar-user-dropdown` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/SidebarUserDropdown (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/SidebarUserDropdown (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/SidebarUserDropdown (curated — add to shadcn-studio-blocks.stories.tsx)` |
