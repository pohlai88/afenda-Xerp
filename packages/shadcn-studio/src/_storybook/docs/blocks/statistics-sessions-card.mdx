...
<Meta title="Shadcn Studio/Promotion/statistics-sessions-card" />

# statistics-sessions-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-sessions-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsSessionsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsSessionsCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-sessions-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsSessionsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
