...
<Meta title="Shadcn Studio/Promotion/dropdown-profile" />

# dropdown-profile — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dropdown-profile` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DropdownProfile (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DropdownProfile (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DropdownProfile (curated — add to shadcn-studio-blocks.stories.tsx)` |
