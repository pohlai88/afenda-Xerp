...
<Meta title="Shadcn Studio/Promotion/statistics-card-04" />

# statistics-card-04 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-card-04` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCard04 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCard04 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCard04 (curated — add to shadcn-studio-blocks.stories.tsx)` |
