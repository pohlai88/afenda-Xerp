...
<Meta title="Shadcn Studio/Promotion/empty-state-01" />

# empty-state-01 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `empty-state-01` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/EmptyState01` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/EmptyState01`)
...
| `blockId` | `empty-state-01` |
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/EmptyState01` |
