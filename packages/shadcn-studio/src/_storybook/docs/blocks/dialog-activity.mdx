...
<Meta title="Shadcn Studio/Promotion/dialog-activity" />

# dialog-activity — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dialog-activity` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DialogActivity (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DialogActivity (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DialogActivity (curated — add to shadcn-studio-blocks.stories.tsx)` |
