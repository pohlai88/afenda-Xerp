...
<Meta title="Shadcn Studio/Promotion/widget-orders" />

# widget-orders — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-orders` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetOrders (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetOrders (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-orders` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetOrders (curated — add to shadcn-studio-blocks.stories.tsx)` |
