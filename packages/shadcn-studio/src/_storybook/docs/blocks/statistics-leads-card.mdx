...
<Meta title="Shadcn Studio/Promotion/statistics-leads-card" />

# statistics-leads-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-leads-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsLeadsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsLeadsCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsLeadsCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
