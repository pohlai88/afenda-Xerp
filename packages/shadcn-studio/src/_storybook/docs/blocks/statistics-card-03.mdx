...
<Meta title="Shadcn Studio/Promotion/statistics-card-03" />

# statistics-card-03 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-card-03` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCard03 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCard03 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCard03 (curated — add to shadcn-studio-blocks.stories.tsx)` |
