...
<Meta title="Shadcn Studio/Promotion/chart-performance" />

# chart-performance — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-performance` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartPerformance (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartPerformance (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-performance` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartPerformance (curated — add to shadcn-studio-blocks.stories.tsx)` |
