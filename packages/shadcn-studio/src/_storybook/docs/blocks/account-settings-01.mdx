...
<Meta title="Shadcn Studio/Promotion/account-settings-01" />

# account-settings-01 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-01` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/AccountSettings01InShell` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/AccountSettings01InShell`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/AccountSettings01InShell` |
