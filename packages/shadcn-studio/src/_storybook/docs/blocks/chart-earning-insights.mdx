...
<Meta title="Shadcn Studio/Promotion/chart-earning-insights" />

# chart-earning-insights — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-earning-insights` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartEarningInsights (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartEarningInsights (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-earning-insights` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartEarningInsights (curated — add to shadcn-studio-blocks.stories.tsx)` |
