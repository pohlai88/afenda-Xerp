...
<Meta title="Shadcn Studio/Promotion/widget-upgrade-your-plan" />

# widget-upgrade-your-plan — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-upgrade-your-plan` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetUpgradeYourPlan (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetUpgradeYourPlan (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-upgrade-your-plan` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetUpgradeYourPlan (curated — add to shadcn-studio-blocks.stories.tsx)` |
