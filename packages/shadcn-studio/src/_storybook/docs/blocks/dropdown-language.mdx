...
<Meta title="Shadcn Studio/Promotion/dropdown-language" />

# dropdown-language — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dropdown-language` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DropdownLanguage (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DropdownLanguage (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DropdownLanguage (curated — add to shadcn-studio-blocks.stories.tsx)` |
