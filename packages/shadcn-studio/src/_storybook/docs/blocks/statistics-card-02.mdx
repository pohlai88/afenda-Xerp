...
<Meta title="Shadcn Studio/Promotion/statistics-card-02" />

# statistics-card-02 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-card-02` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCard02 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCard02 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCard02 (curated — add to shadcn-studio-blocks.stories.tsx)` |
