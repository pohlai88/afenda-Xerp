...
<Meta title="Shadcn Studio/Promotion/statistics-total-growth-card" />

# statistics-total-growth-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-total-growth-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsTotalGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsTotalGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-total-growth-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsTotalGrowthCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
