...
<Meta title="Shadcn Studio/Promotion/login-page-04" />

# login-page-04 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `login-page-04` |
| **Block class** | auth-adjacent |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/LoginPage04` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/LoginPage04`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/LoginPage04` |
