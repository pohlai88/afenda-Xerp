...
<Meta title="Shadcn Studio/Promotion/widget-general-finance-reviews" />

# widget-general-finance-reviews — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-general-finance-reviews` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetGeneralFinanceReviews (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetGeneralFinanceReviews (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-general-finance-reviews` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetGeneralFinanceReviews (curated — add to shadcn-studio-blocks.stories.tsx)` |
