...
<Meta title="Shadcn Studio/Promotion/statistics-finance-card" />

# statistics-finance-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-finance-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsFinanceCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsFinanceCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-finance-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsFinanceCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
