...
<Meta title="Shadcn Studio/Promotion/widget-monthly-campaign" />

# widget-monthly-campaign — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-monthly-campaign` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetMonthlyCampaign (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetMonthlyCampaign (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-monthly-campaign` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetMonthlyCampaign (curated — add to shadcn-studio-blocks.stories.tsx)` |
