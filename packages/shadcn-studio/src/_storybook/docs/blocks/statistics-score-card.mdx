...
<Meta title="Shadcn Studio/Promotion/statistics-score-card" />

# statistics-score-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-score-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsScoreCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsScoreCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-score-card` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsScoreCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
