...
<Meta title="Shadcn Studio/Promotion/datatable-user" />

# datatable-user — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `datatable-user` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DatatableUser (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DatatableUser (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/DatatableUser (curated — add to shadcn-studio-blocks.stories.tsx)` |
