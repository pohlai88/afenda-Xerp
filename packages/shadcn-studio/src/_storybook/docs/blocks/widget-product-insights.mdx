...
<Meta title="Shadcn Studio/Promotion/widget-product-insights" />

# widget-product-insights — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-product-insights` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetProductInsights (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetProductInsights (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-product-insights` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetProductInsights (curated — add to shadcn-studio-blocks.stories.tsx)` |
