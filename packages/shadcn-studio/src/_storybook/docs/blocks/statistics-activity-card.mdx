...
<Meta title="Shadcn Studio/Promotion/statistics-activity-card" />

# statistics-activity-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-activity-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsActivityCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsActivityCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsActivityCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
