...
<Meta title="Shadcn Studio/Promotion/widget-browser-states" />

# widget-browser-states — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-browser-states` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetBrowserStates (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetBrowserStates (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `widget-browser-states` |
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetBrowserStates (curated — add to shadcn-studio-blocks.stories.tsx)` |
