...
<Meta title="Shadcn Studio/Promotion/statistics-sales-overview-card" />

# statistics-sales-overview-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-sales-overview-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsSalesOverviewCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsSalesOverviewCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsSalesOverviewCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
