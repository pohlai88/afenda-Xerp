...
<Meta title="Shadcn Studio/Promotion/account-settings-02" />

# account-settings-02 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `account-settings-02` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks Auto/AccountSettings02` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks Auto/AccountSettings02`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks Auto/AccountSettings02` |
