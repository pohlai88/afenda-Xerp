...
<Meta title="Shadcn Studio/Promotion/statistics-expense-card" />

# statistics-expense-card — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-expense-card` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsExpenseCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsExpenseCard (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsExpenseCard (curated — add to shadcn-studio-blocks.stories.tsx)` |
