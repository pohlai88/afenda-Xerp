...
<Meta title="Shadcn Studio/Promotion/chart-conversion-rate" />

# chart-conversion-rate — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `chart-conversion-rate` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/ChartConversionRate (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/ChartConversionRate (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `chart-conversion-rate` |
| `presentationLabProof` | `Shadcn Studio/Blocks/ChartConversionRate (curated — add to shadcn-studio-blocks.stories.tsx)` |
