...
<Meta title="Shadcn Studio/Promotion/datatable-course" />

# datatable-course — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `datatable-course` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DatatableCourse (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DatatableCourse (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `datatable-course` |
| `presentationLabProof` | `Shadcn Studio/Blocks/DatatableCourse (curated — add to shadcn-studio-blocks.stories.tsx)` |
