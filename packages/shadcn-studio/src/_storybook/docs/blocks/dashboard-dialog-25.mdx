...
<Meta title="Shadcn Studio/Promotion/dashboard-dialog-25" />

# dashboard-dialog-25 — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `dashboard-dialog-25` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/DashboardDialog25 (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/DashboardDialog25 (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `dashboard-dialog-25` |
| `presentationLabProof` | `Shadcn Studio/Blocks/DashboardDialog25 (curated — add to shadcn-studio-blocks.stories.tsx)` |
