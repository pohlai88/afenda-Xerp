...
<Meta title="Shadcn Studio/Promotion/widget-transactions" />

# widget-transactions — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `widget-transactions` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/WidgetTransactions (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/WidgetTransactions (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `presentationLabProof` | `Shadcn Studio/Blocks/WidgetTransactions (curated — add to shadcn-studio-blocks.stories.tsx)` |
