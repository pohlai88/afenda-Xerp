...
<Meta title="Shadcn Studio/Promotion/statistics-company-stock-graph" />

# statistics-company-stock-graph — promotion checklist

| Field | Value |
| --- | --- |
| **Block id** | `statistics-company-stock-graph` |
| **Block class** | general-operator |
| **Storybook proof** | `Shadcn Studio/Blocks/StatisticsCompanyStockGraph (curated — add to shadcn-studio-blocks.stories.tsx)` |
...
- [ ] **1.** Presentation lab story exists (`Shadcn Studio/Blocks/StatisticsCompanyStockGraph (curated — add to shadcn-studio-blocks.stories.tsx)`)
...
| `blockId` | `statistics-company-stock-graph` |
| `presentationLabProof` | `Shadcn Studio/Blocks/StatisticsCompanyStockGraph (curated — add to shadcn-studio-blocks.stories.tsx)` |
