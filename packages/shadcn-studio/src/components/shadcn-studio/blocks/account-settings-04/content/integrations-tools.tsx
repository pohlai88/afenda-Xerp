  ...
  const partnerApps = [
    {
      name: "GitHub",
      description:
        "Connect your code repositories and manage issues seamlessly",
      image:
    ...
    },
    {
      name: "Figma",
      description:
        "Collaborate on design projects and share feedback in real time",
    ...
    },
    {
      name: "Sketch",
      description:
        "Design and prototype with ease using our Sketch integration",
      image:
        "https://cdn.shadcnstudio.com/ss-assets/brand-logo/sketch-logo.png",
    ...
    },
    {
      ...
      image:
        "https://cdn.shadcnstudio.com/ss-assets/brand-logo/zapier-icon.png",
      bgColor: "bg-destructive/10",
      link: "#",
    },
  ];
