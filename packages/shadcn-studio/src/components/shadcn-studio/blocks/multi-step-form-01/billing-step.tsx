    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='grid grid-cols-12 gap-6'>
        ...
        <div className='col-span-12 flex flex-col items-start gap-2 md:col-span-6'>
          ...
          <Input id='multi-step-billing-name' placeholder='John Doe' className='input-lg' />
        </div>
        ...
        <div className='col-span-6 flex flex-col items-start gap-2 md:col-span-3'>
          ...
          <Input {...getCVCProps()} id='multi-step-billing-cvc' placeholder='123' className='input-lg' />
        </div>
      </div>
