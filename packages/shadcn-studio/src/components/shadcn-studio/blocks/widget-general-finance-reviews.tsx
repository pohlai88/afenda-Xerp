...
import { EllipsisVerticalIcon, WalletIcon, ChevronUpIcon, ChevronDownIcon } from "lucide-react"
    ...
    <Card className={className}>
      <CardContent className='space-y-6'>
        ...
        <div className='flex items-center gap-3'>
          <Avatar className='size-13 rounded-sm after:border-0'>
      ...
      <CardContent className='space-y-2'>
        ...
        <Progress value={progressValue} className='**:data-[slot=progress-track]:h-1.5' />
      </CardContent>
