          ...
          <CardContent className='flex w-full flex-col gap-3'>
            ...
            <div className='col-span-2 md:col-span-3'>
              <ToggleGroup
                ...
                multiple
                className='*:data-[slot=toggle-group-item]:bg-muted *:aria-[pressed=true]:bg-primary! *:aria-[pressed=true]:text-primary-foreground gap-2 *:data-[slot=toggle-group-item]:size-8 *:data-[slot=toggle-group-item]:rounded-full!'
              >
