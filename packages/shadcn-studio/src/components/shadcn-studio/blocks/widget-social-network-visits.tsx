...
import { EllipsisVerticalIcon, ChevronUpIcon } from "lucide-react"
          ...
          <div key={index} className='flex flex-1 items-center justify-between gap-2'>
            <div className='flex items-center justify-between gap-2'>
              ...
              <div className='flex flex-col gap-0.5'>
                <span className='text-base font-medium'>{visit.platform}</span>
            ...
            <div className='flex items-center justify-between gap-2 text-sm'>
              ...
              <Badge className='bg-primary/10 text-primary h-6 px-3 py-1'>
