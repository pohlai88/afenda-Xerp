...
/** Gold reference (v1.2.0) — cva variants in contract; composeClassName + WithoutGovernedDataSlot adapter. */
export const PRIMITIVE_CONTRACT_VERSION = "1.2.0" as const;

/** Stable id for metadata binding / diagnostics registries. */
export const BUTTON_PRIMITIVE_ID = "shadcn-studio.ui.button" as const;
export type ButtonPrimitiveId = typeof BUTTON_PRIMITIVE_ID;

export const BUTTON_SLOTS = {
  root: "button",
} as const;

export type ButtonSlotMap = typeof BUTTON_SLOTS;
export type ButtonSlot = ButtonSlotMap[keyof ButtonSlotMap];
...
export function buttonPrimitiveMetadata() {
  return {
    id: BUTTON_PRIMITIVE_ID,
