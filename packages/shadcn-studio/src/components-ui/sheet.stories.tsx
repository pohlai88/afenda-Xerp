...
import { SheetDefaultSample } from "../storybook/primitive-story.compositions.js";

const meta = {
  component: SheetDefaultSample,
...
} satisfies Meta<typeof SheetDefaultSample>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Default: Story = {
  render: () => <SheetDefaultSample />,
};
