...
export const inputGroupTextClassName =
  "flex items-center gap-2 text-muted-foreground text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none" as const;

export const inputGroupInputClassName =
  "flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent" as const;

export const inputGroupTextareaClassName =
  "flex-1 resize-none rounded-none border-0 bg-transparent py-2 shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent" as const;

export function inputGroupPrimitiveMetadata() {
  return {
    id: INPUT_GROUP_PRIMITIVE_ID,
    version: PRIMITIVE_CONTRACT_VERSION,
    slots: INPUT_GROUP_SLOTS,
  } as const;
}
