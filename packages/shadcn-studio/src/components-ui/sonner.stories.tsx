...
import { SonnerDefaultSample } from "../storybook/primitive-story.compositions.js";

const meta = {
  component: SonnerDefaultSample,
...
} satisfies Meta<typeof SonnerDefaultSample>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Default: Story = {
  render: () => <SonnerDefaultSample />,
};
