...
export default function RegisterPage01() {
  return (
    <AuthShellStage
      ...
      variant="access"
    >
      <div className="grid min-h-[calc(100dvh-2rem)] w-full overflow-hidden rounded-[32px] border border-white/10 bg-background/78 shadow-2xl shadow-black/25 backdrop-blur-xl lg:grid-cols-[minmax(0,1fr)_minmax(26rem,34rem)]">
        <section
          {...blockSlotDomMarkerProps("register.branding")}
          className="flex flex-col justify-between gap-10 border-white/8 bg-primary p-8 text-primary-foreground max-lg:border-b lg:border-r lg:p-14 xl:p-16"
        >
        ...
        <section className="flex items-center justify-center px-4 py-8 lg:px-8">
          <Card className="w-full max-w-lg gap-6 border-0 bg-transparent py-0 shadow-none lg:border-0 lg:py-6">
            ...
            <CardContent className="space-y-5 px-0 lg:px-6">
              <div aria-hidden="true" className="sr-only">
                ...
                <span
                  {...blockSlotDomMarkerProps("register.confirmPassword")}
                />
