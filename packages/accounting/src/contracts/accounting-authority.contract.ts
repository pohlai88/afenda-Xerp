/**
 * ADR-0015 — Accounting domain authority (contracts-only lifecycle).
 * Serializable surface only; no ledger, journal, or posting types.
 */

export const ACCOUNTING_AUTHORITY_ADR = "ADR-0015" as const;

export const ACCOUNTING_REGISTRY_ID = "PKG-R01" as const;

export const ACCOUNTING_AUTHORITY_FINGERPRINT =
  "ACCOUNTING-AUTHORITY-2026-06-24-v1" as const;
