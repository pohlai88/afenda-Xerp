...
export const inputGroupSlotClassNames = {
  root: "group/input-group relative flex h-8 w-full min-w-0 items-center rounded-lg border border-(--afenda-form-field-border) bg-(--afenda-form-field-background) transition-colors outline-none in-data-[slot=combobox-content]:focus-within:border-inherit in-data-[slot=combobox-content]:focus-within:ring-0 has-disabled:bg-(--afenda-form-field-disabled-background) has-disabled:opacity-50 has-[[data-slot=input-group-control]:focus-visible]:border-(--afenda-form-field-border-focus) has-[[data-slot=input-group-control]:focus-visible]:ring-2 has-[[data-slot=input-group-control]:focus-visible]:ring-ring/25 has-[[data-slot][aria-invalid=true]]:border-(--afenda-form-field-invalid-border) has-[[data-slot][aria-invalid=true]]:ring-2 has-[[data-slot][aria-invalid=true]]:ring-destructive/15 has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col has-[>textarea]:h-auto dark:has-[[data-slot][aria-invalid=true]]:ring-destructive/40 has-[>[data-align=block-end]]:[&>input]:pt-3 has-[>[data-align=block-start]]:[&>input]:pb-3 has-[>[data-align=inline-end]]:[&>input]:pr-1.5 has-[>[data-align=inline-start]]:[&>input]:pl-1.5",
...
export const inputOtpSlotClassNames = {
  ...
  control:
    "relative flex size-8 items-center justify-center border-y border-r border-(--afenda-form-field-border) bg-(--afenda-form-field-background) text-sm transition-all outline-none first:rounded-l-lg first:border-l last:rounded-r-lg aria-invalid:border-(--afenda-form-field-invalid-border) data-[active=true]:z-10 data-[active=true]:border-(--afenda-form-field-border-focus) data-[active=true]:ring-2 data-[active=true]:ring-ring/30 data-[active=true]:aria-invalid:border-(--afenda-form-field-invalid-border) data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40",
  icon: "flex items-center [&_svg:not([class*='size-'])]:size-4",
} as const;

export const inputOtpSlotClassNamesByKey = {
  "group-shell":
    "flex items-center rounded-lg has-aria-invalid:border-destructive has-aria-invalid:ring-2 has-aria-invalid:ring-destructive/15 dark:has-aria-invalid:ring-destructive/40",
  "caret-blink":
...
export const nativeSelectSlotClassNames = {
  ...
  control:
    "h-8 w-full min-w-0 appearance-none rounded-lg border border-(--afenda-form-field-border) bg-(--afenda-form-field-background) py-1 pr-8 pl-2.5 text-sm transition-colors outline-none select-none selection:bg-primary selection:text-primary-foreground placeholder:text-(--afenda-form-field-placeholder) focus-visible:border-(--afenda-form-field-border-focus) focus-visible:ring-2 focus-visible:ring-ring/25 disabled:pointer-events-none disabled:cursor-not-allowed aria-invalid:border-(--afenda-form-field-invalid-border) aria-invalid:ring-2 aria-invalid:ring-destructive/15 data-[size=sm]:h-7 data-[size=sm]:rounded-[min(var(--radius-md),10px)] data-[size=sm]:py-0.5 dark:aria-invalid:border-(--afenda-form-field-invalid-border) dark:aria-invalid:ring-destructive/40",
...
export const comboboxSlotClassNames = {
  ...
  actions:
    "flex min-h-8 flex-wrap items-center gap-1 rounded-lg border border-(--afenda-form-field-border) bg-(--afenda-form-field-background) bg-clip-padding px-2.5 py-1 text-sm transition-colors focus-within:border-(--afenda-form-field-border-focus) focus-within:ring-2 focus-within:ring-ring/25 has-aria-invalid:border-(--afenda-form-field-invalid-border) has-aria-invalid:ring-2 has-aria-invalid:ring-destructive/15 has-data-[slot=combobox-chip]:px-1 dark:has-aria-invalid:border-(--afenda-form-field-invalid-border) dark:has-aria-invalid:ring-destructive/40",
  header:
...
export const calendarSlotClassNamesByKey = {
  ...
  "chevron-icon": "size-4",
  "day-button":
    "relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-2 group-data-[focused=true]/day:ring-ring/30 data-[range-end=true]:rounded-(--cell-radius) data-[range-end=true]:rounded-r-(--cell-radius) data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-muted data-[range-middle=true]:text-foreground data-[range-start=true]:rounded-(--cell-radius) data-[range-start=true]:rounded-l-(--cell-radius) data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground dark:hover:text-foreground [&>span]:text-xs [&>span]:opacity-70",
} as const;
