...
import { Avatar, AvatarGroup, AvatarFallback, AvatarImage } from '#/components/shadcn-studio/primitives/avatar.tsx'
import {
  CommandDialog,
  CommandEmpty,
  CommandGroup,
  ...
  CommandList,
  CommandSeparator
} from '#/components/shadcn-studio/primitives/command.tsx'
  ...
  return (
    <div className={className}>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className='max-h-[65vh]'>
          ...
          >
            <CommandItem onSelect={() => setOpen(false)} className='gap-3 py-1.5! text-base'>
              ...
              <AvatarGroup className='**:data-[slot=avatar]:ring-background **:data-[slot=avatar]:ring-2 **:data-[slot=avatar]:grayscale'>
                <Avatar>
        ...
        <div className='text-muted-foreground flex flex-wrap items-center gap-4 p-6 max-sm:hidden'>
