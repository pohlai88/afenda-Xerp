...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '#/components/shadcn-studio/primitives/table.tsx'
import { Progress } from '#/components/shadcn-studio/primitives/progress.tsx'
                    ...
                    <TableCell className='px-6'>
                      {item.status === 'progress' ? (
                        <div className='flex flex-col items-start gap-1'>
                          ...
                          <Progress value={item.progress} className='w-20 md:w-60' />
                        </div>
                      ) : (
