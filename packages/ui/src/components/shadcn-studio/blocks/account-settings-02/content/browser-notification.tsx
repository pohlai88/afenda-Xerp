...
import { Tooltip, TooltipContent, TooltipTrigger } from '#/components/shadcn-studio/primitives/tooltip.tsx'
      ...
      <div className='space-y-4 lg:col-span-2'>
        <div className='space-y-3'>
          <div className='flex items-center gap-4'>
            ...
            <Label htmlFor='assigned-to-you' className='text-sm font-medium'>
              Assigned to You
            </Label>
          </div>
          <div className='flex items-center gap-4'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <Label htmlFor='assigned-to-teams' className='text-sm font-medium'>
