...
import { ScrollArea } from '#/components/shadcn-studio/primitives/scroll-area.tsx'
          ...
          <ScrollArea className='flex max-h-full flex-col overflow-hidden'>
            <div className='flex flex-col gap-4 p-6'>
              ...
              <div className='flex flex-col gap-6'>
                ...
                >
                  <div className='border-input has-data-[state=checked]:border-primary/50 has-data-[state=checked]:bg-primary/10 relative flex w-full gap-2 rounded-lg border p-3 outline-none'>
                    <RadioGroupItem
