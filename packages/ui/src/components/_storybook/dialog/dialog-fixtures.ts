...
export const DIALOG_SUBSCRIBE_SUBMIT_LABEL = "Subscribe";

export const DIALOG_SUBSCRIBE_EMAIL_LABEL = "Work email";

export const DIALOG_SUBSCRIBE_EMAIL_PLACEHOLDER = "name@company.com";
