...
import {
  ...
  ResizableFrame,
  SectionLabel,
} from "./_storybook/resizable-story.compositions";
...
export const GovernanceDataAuthority: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Consumer `data-*` props cannot override governed Resizable panel group, panel, or handle attributes.",
      },
    },
  },
  render: () => (
    <ResizableFrame width="md">
      ...
      >
        <ResizablePanel
          ...
          defaultSize={50}
        >
          <PanelShell centered title="Governed panel" />
        </ResizablePanel>
        <ResizableHandle
          data-component="Override"
          data-slot="override"
        ...
        />
        <ResizablePanel defaultSize={50}>
          <PanelShell centered title="Governed split" />
        </ResizablePanel>
      </ResizablePanelGroup>
    </ResizableFrame>
  ),
