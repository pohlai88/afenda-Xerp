...
exports.capabilityList = exports.capabilities = void 0;
...
exports.capabilityList = Object.values(exports.capabilities);
function getCapability(capabilityKey) {
    var _a;
    return ((_a = exports.capabilityList.find(function (capability) { return capability.key === capabilityKey; })) !== null && _a !== void 0 ? _a : null);
}
