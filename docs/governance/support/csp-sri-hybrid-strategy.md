...
- `docs/governance/support/nextjs-csp-nonce-pipeline.md` — nonce pipeline (protected surfaces)
- `docs/governance/support/csp-supabase-platform-approval.md` — Supabase connect/img origins
- `docs/governance/support/csp-third-party-ci-gate.md` — third-party script governance
