...
```
Handoff from: docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b47-pas004c-consumer-projection-adoption.md
...
2. Allowed layer— packages/ui-composition/src/knowledge/** · apps/erp/src/lib/knowledge/** · scripts/governance/check-knowledge-*-consumer*.mts
                  · packages/enterprise-knowledge/src/data/atoms.json (double_entry only) · docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b47-pas004c-consumer-projection-adoption.md
3. Files        —
