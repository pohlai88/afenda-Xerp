...
```
Handoff from: docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b48-pas004c-docs-consumer-projection-adoption.md
...
2. Allowed layer— apps/docs/src/lib/knowledge/** · scripts/governance/check-knowledge-docs-consumer-proof.mts
                  · docs/PAS/pas-status-index.md · docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b46-pas004c-semantic-attestation.md
                  · docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b48-pas004c-docs-consumer-projection-adoption.md
3. Files        —
