...
```
Handoff from: docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b27-consumer-proof.md
...
2. Allowed layer— apps/erp/src/lib/knowledge/** · apps/erp/package.json · scripts/governance/check-knowledge-consumer-proof.mts · package.json (script) · docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b27-consumer-proof.md · docs/PAS/ENTERPRISE-KNOWLEDGE/PAS-004A-ENTERPRISE-KNOWLEDGE-PLATFORM-STANDARD.md (status)
3. Files        —
   ...
   package.json
   docs/PAS/ENTERPRISE-KNOWLEDGE/SLICE/b27-consumer-proof.md
