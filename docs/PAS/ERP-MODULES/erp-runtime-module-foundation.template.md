...
>
> **Canonical location:** `docs/PAS/ERP-MODULES/erp-runtime-module-foundation.template.md`
>
...
```ts
packages/features/erp-modules/src/{module-slug}/{module-slug}.module-definition.ts
```
...
Authority: [PAS-001C — ERP Module Foundation Standard](../KERNEL/PAS-001C-ERP-MODULE-FOUNDATION-STANDARD.md) §6.
