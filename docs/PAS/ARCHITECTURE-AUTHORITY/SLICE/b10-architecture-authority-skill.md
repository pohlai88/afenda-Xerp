...
2. Allowed layer— .cursor/skills/architecture-authority/ + docs/PAS/ARCHITECTURE-AUTHORITY/PAS-002-ARCHITECTURE-AUTHORITY.md + docs/PAS/pas-status-index.md
3. Files        — .cursor/skills/architecture-authority/SKILL.md (MODIFY)
                  docs/PAS/ARCHITECTURE-AUTHORITY/PAS-002-ARCHITECTURE-AUTHORITY.md (MODIFY §0, §12)
