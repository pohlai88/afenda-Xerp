...
2. Allowed layer— scripts/governance/** ┬À scripts/quality/** ┬À package.json script registration
...
5. Authority    — PAS-002A §4.3 ┬À PAS-002 §6.2 ┬À architecture-authority skill
6. Gates        — PAS-002 §13.1 ┬À pnpm check:architecture-governance-consumer-proof ┬À pnpm check:architecture-authority-surface
7. Closes       — Governance consumer import discipline proof
8. Evidence     — gate exit 0; zero deep-path imports in scanned scripts
9. Attestation  — Architecture ┬À Governance
```
