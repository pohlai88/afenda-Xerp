...
2. Allowed layer— packages/architecture-authority/src/data/ownership-registry.data.ts · scripts/governance/** · packages/architecture-authority tests (parity only)
3. Files        — packages/architecture-authority/src/data/ownership-registry.data.ts · scripts/governance/check-architecture-ownership-signoff.mts
