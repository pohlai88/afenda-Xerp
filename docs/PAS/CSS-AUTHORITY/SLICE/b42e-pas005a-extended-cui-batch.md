...
**Clean Core impact:** AÔåÆA — MCP re-seed only; no legacy TSX migration
...
2. Allowed layer— packages/shadcn-studio/** · docs/PAS/CSS-AUTHORITY/SLICE/b42e-pas005a-extended-cui-batch.md · docs/PAS/pas-status-index.md
3. Files        —
