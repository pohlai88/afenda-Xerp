# Slice B36 ÔÇö PAS-005 Post-B34/B35 Risk Mitigation (PAS-005 ┬º14 P6ÔÇôP7)
...
**Risk class:** Low ÔÇö registry emit performance, drift gates, appshell CSS defect

## Handoff block

```
Handoff from: docs/PAS/CSS-AUTHORITY/SLICE/b36-pas005-risk-mitigation.md

1. Objective    ÔÇö Mitigate PAS-005 post-B34/B35 risks: thin registry TS emit, domain-sync drift gate, R28ÔÇôR30 consumption rules, P6 --app-shell-content-padding-inline fix, PAS documentation closure.
2. Allowed layerÔÇö packages/css-authority/** ┬À packages/appshell/src/styles/afenda-appshell.css (P6) ┬À scripts/governance/check-css-authority-*.mts ┬À root package.json (check script) ┬À docs/PAS/**
3. Files        ÔÇö
   ...
   package.json
   docs/PAS/CSS-AUTHORITY/SLICE/b36-pas005-risk-mitigation.md
   docs/PAS/CSS-AUTHORITY/PAS-005-CSS-AUTHORITY-STANDARD.md
   docs/PAS/pas-status-index.md
4. Prohibited   ÔÇö delete @afenda/design-system CSS exports ┬À edit packages/ui ┬À apps/** ┬À hand-edit generated registry JSON without build
5. Authority    ÔÇö PAS-005 ┬À CSS Authority ┬À @afenda/css-authority
6. Gates        ÔÇö
...
7. Closes       ÔÇö PAS-005 ┬º14 P6 (padding var) ┬À P7 (domain-sync + extended consumption) ┬À Risk 1ÔÇô3 registry/gate gaps
8. Evidence     ÔÇö
   src/generated/css-authority-registry.ts (<100 lines, JSON import wrapper)
   appshell.json 44 tokens ┬À merged registry 569 tokens
   check:css-authority-domain-sync ┬À R28ÔÇôR30 consumption rules
9. Attestation  ÔÇö design-system B30 shim retains css-authority import; no design-system CSS deletion
```
