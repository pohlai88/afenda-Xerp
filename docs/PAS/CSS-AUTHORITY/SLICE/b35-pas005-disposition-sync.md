...
2. Allowed layer— packages/architecture-authority/src/data/foundation-disposition.registry.ts · packages/architecture-authority/src/data/foundation-disposition.registry.ts · docs/PAS/** 
3. Files        —
