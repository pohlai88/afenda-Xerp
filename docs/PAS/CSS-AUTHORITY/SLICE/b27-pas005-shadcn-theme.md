...
**Clean Core impact:** AÔåÆA — generated registry + vendored CSS; consumers unchanged until B29
...
2. Allowed layer— packages/css-authority/** · docs/PAS/CSS-AUTHORITY/SLICE/b27-pas005-shadcn-theme.md · docs/PAS/pas-status-index.md
3. Files        —
