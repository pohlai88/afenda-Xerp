...
**Clean Core impact:** AÔåÆA — clarifies studio vs block-local CSS ownership; manifest invariants unchanged
...
2. Allowed layer— packages/appshell/src/styles/afenda-appshell-studio.css · packages/appshell/src/styles/afenda-appshell.css (comment-only dedup) · packages/appshell/src/__tests__/css-manifest.test.ts · docs/PAS/CSS-AUTHORITY/SLICE/b42l-*.md · docs/PAS/pas-status-index.md · docs/PAS/CSS-AUTHORITY/PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md (§14 row) · docs/PAS/CSS-AUTHORITY/SLICE/b42j-pas005a-wrapper-expansion-delegating-flip.md (deferred section)
