...
**Clean Core impact:** AÔåÆA — documents delegating-flip rationale; MCP lab className policy unchanged; strangler complete
...
2. Allowed layer— packages/appshell/src/presentation/wrappers/presentation-mcp-delegating-flip-policy.registry.ts · packages/appshell/src/__tests__/presentation-mcp-delegating-flip-policy.test.ts · packages/shadcn-studio/src/__tests__/mcp-presentation-classname-policy.test.ts · docs/PAS/CSS-AUTHORITY/SLICE/b42p-*.md · docs/PAS/pas-status-index.md · docs/PAS/CSS-AUTHORITY/PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md (§14 row)
