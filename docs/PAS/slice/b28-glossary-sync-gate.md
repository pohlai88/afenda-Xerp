...
```
Handoff from: docs/PAS/slice/b28-glossary-sync-gate.md

1. Objective    — Add machine-readable glossary atom ID manifest; gate validates IDs ⊆ registry and header authority unchanged.
2. Allowed layer— docs/architecture/glossary.md · scripts/governance/check-glossary-knowledge-sync.mts · package.json (script) · docs/PAS/slice/b28-glossary-sync-gate.md · docs/PAS/PAS-004A-ENTERPRISE-KNOWLEDGE-PLATFORM-STANDARD.md (status)
3. Files        —
   docs/architecture/glossary.md
   scripts/governance/check-glossary-knowledge-sync.mts
   package.json
   docs/PAS/slice/b28-glossary-sync-gate.md
