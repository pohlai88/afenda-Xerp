...
```
Handoff from: docs/PAS/slice/b34-pas005-registry-expansion.md
...
2. Allowed layer— packages/css-authority/** · docs/PAS/slice/b34-pas005-registry-expansion.md · docs/PAS/pas-status-index.md · docs/PAS/PAS-005-CSS-AUTHORITY-STANDARD.md (§14 + header metadata)
3. Files        —
   ...
   docs/PAS/slice/b34-pas005-registry-expansion.md
...
- **Token counts:** 465 `--afenda-*` · 43 `--app-shell-*` (`.app-shell-root` block) · 14 `--auth-editorial-*` · 46 shadcn (unchanged) → **568 total**.
