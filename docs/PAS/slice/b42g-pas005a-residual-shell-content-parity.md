...
**Clean Core impact:** A→A — MCP re-seed + strangler registry only; no legacy TSX migration

## Handoff block

```
Handoff from: docs/PAS/slice/b42g-pas005a-residual-shell-content-parity.md
...
| Parity (registry entries / legacy) | **106%** (gate uses entry count ≥ 63) |
| **Delete blocked** | **No** |
