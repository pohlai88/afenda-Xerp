...
**Clean Core impact:** A→A — presentation runtime only; no Afenda imports
...
```
Handoff from: docs/PAS/slice/b39-pas005a-theme-presets.md
...
2. Allowed layer— packages/shadcn-studio/** · docs/PAS/slice/b39-pas005a-theme-presets.md · docs/PAS/pas-status-index.md · docs/PAS/PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md (runtime_status sync)
3. Files        —
   ...
   docs/PAS/slice/b39-pas005a-theme-presets.md
...
7. Closes       — PAS-005A theme preset surface Target → Current; B39 proposed → delivered
8. Evidence     —
   packages/shadcn-studio/src/theme/theme-presets.ts
   packages/shadcn-studio/src/theme/settings-context.tsx
   packages/shadcn-studio/src/__tests__/theme-presets.test.ts
