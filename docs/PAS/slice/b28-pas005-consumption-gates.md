...
```
Handoff from: docs/PAS/slice/b28-pas005-consumption-gates.md
...
2. Allowed layer— scripts/css/** · scripts/governance/check-css-authority-consumption.mts · package.json (check script only) · docs/PAS/slice/b28-pas005-consumption-gates.md · docs/PAS/pas-status-index.md
3. Files        —
   scripts/css/css-registry.mts
   scripts/css/check-css-governance.mts
   scripts/governance/check-css-authority-consumption.mts
   package.json
   docs/PAS/slice/b28-pas005-consumption-gates.md
