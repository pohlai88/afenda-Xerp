...
```
Handoff from: docs/PAS/slice/b26-kernel-mapping-gate.md
...
2. Allowed layer— packages/enterprise-knowledge/** · scripts/governance/check-knowledge-kernel-mapping.mts
                  · package.json (script only) · docs/PAS/slice/b26-kernel-mapping-gate.md · docs/PAS/PAS-004A-*.md (status)
3. Files        —
   ...
   package.json
   docs/PAS/slice/b26-kernel-mapping-gate.md
   docs/PAS/PAS-004A-ENTERPRISE-KNOWLEDGE-PLATFORM-STANDARD.md                      (§17 status)
