...
```
Handoff from: docs/PAS/slice/b37-pas005-pixel-baselines.md
...
3. Files        —
   ...
   docs/PAS/slice/b37-pas005-pixel-baselines.md
...
- **Playwright config:** `pathTemplate: '{testDir}/visual-proof/{arg}{ext}'`, viewport 1280×720, `maxDiffPixelRatio: 0.02`, `animations: 'disabled'`.
