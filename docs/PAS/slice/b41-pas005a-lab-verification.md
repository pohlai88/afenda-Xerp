...
**Clean Core impact:** A→A — Storybook consumer of standalone package

## Purpose

Prove `@afenda/shadcn-studio` in lab: Storybook stories for ThemeCustomizer (all presets × light/dark), representative primitives, and at least one MCP block. Wire `apps/storybook` to import `@afenda/shadcn-studio` CSS + components without ERP or Afenda governance packages.

## Handoff block

```
Handoff from: docs/PAS/slice/b41-pas005a-lab-verification.md
...
2. Allowed layer— apps/storybook/** · packages/shadcn-studio/src/_storybook/** · packages/shadcn-studio/package.json · docs/PAS/slice/b41-pas005a-lab-verification.md · docs/PAS/pas-status-index.md
3. Files        —
   ...
   docs/PAS/slice/b41-pas005a-lab-verification.md
   docs/PAS/PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md (runtime_status sync)
...
7. Closes       — PAS-005A Phase 1 lab proof; B41 proposed → delivered; implementation_status partial → implemented (Phase 1)
8. Evidence     —
   apps/storybook/stories/shadcn-studio-theme-lab.stories.tsx
   apps/storybook/stories/shadcn-studio-block.stories.tsx
