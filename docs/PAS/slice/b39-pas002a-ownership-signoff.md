...
```
Handoff from: docs/PAS/slice/b39-pas002a-ownership-signoff.md
...
2. Allowed layer— docs/architecture/ownership-registry.md · scripts/governance/** · packages/architecture-authority tests (parity only)
3. Files        — docs/architecture/ownership-registry.md · scripts/governance/check-architecture-ownership-signoff.mts
4. Prohibited   — foundation-disposition.registry.ts direct edit; changing ownership rows without ADR-0004 process
5. Authority    — PAS-002A §4.2 · ADR-0004 · architecture-authority skill
6. Gates        — PAS-002 §13.1 · pnpm check:architecture-ownership-signoff · pnpm architecture:owners
