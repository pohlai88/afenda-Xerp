...
```
Handoff from: docs/PAS/slice/b42-pas005a-afenda-integration.md
...
3. Files        —
   ...
   docs/PAS/slice/b42-pas005a-afenda-integration.md
...
5. Registry mutation → `foundation-registry-owner` only
...
**B40-MCP** — Re-run MCP `/rui` + `/cui` with live credentials to replace B40 manual seed (`docs/PAS/slice/b40-pas005a-mcp-seed.md` addendum or `b40b-pas005a-mcp-live-seed.md`).
