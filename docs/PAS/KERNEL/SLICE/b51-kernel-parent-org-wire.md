# Slice B51 — Parent Org Wire (PAS-001 §4.4)

> **Position:** Slice `3 of 12` in PAS-001 · Blueprint box: `Kernel Vocabulary`

**Prerequisite:** B50 Delivered
...
```
Handoff from: docs/PAS/KERNEL/SLICE/b51-kernel-parent-org-wire.md

1. Objective    — Wire parent organization context triad and ERP mapper enrichment for hierarchy traversal
2. Allowed layer— packages/kernel/src/context/** · apps/erp/src/lib/context/** · docs/PAS/KERNEL/SLICE/**
3. Files        —
   docs/PAS/KERNEL/SLICE/b51-kernel-parent-org-wire.md
...
7. Closes       — Closes DoD #1–#3 · Parent Org Wire
8. Evidence     —
   packages/kernel/src/context/organization-unit-context.parser.ts
   apps/erp/src/lib/context/operating-context.mappers.ts
   docs/PAS/KERNEL/SLICE/b51-kernel-parent-org-wire.md
...
| --- | --- |
| 1 | packages/kernel/src/context/organization-unit-context.parser.ts |
| 2 | apps/erp/src/lib/context/operating-context.mappers.ts |
| 3 | docs/PAS/KERNEL/SLICE/b51-kernel-parent-org-wire.md |

## Runtime evidence

| Capability | Proven | Evidence path |
| --- | --- | --- |
| Parent Org Wire | Yes — B51 | `packages/kernel/src/context/organization-unit-context.parser.ts` |
