...
| --- | --- | --- | --- |
| S1 | [pas-001a-api-binding-s1-erp-api-consumption-boundary.md](./pas-001a-api-binding-s1-erp-api-consumption-boundary.md) | ERP consumes API authority | **Delivered** |
