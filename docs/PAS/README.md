...
| [PAS-004C](PAS-004C-ENTERPRISE-KNOWLEDGE-SEMANTIC-MODEL-STANDARD.md) | `@afenda/enterprise-knowledge` | Platform | Production Candidate target (semantic model North Star; B38–B46; derived from PAS-004B) |
...
| [PAS-005A](PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md) | `@afenda/shadcn-studio` | Design / Presentation | MVP Authority — derived from PAS-005; B38 next (standalone shadcn/studio product) |
...
| PAS-005A | `.cursor/skills/shadcn-studio-authority/SKILL.md` (target — create on B38) |
