...
| --- | --- | --- | --- |
| **PAS-API-001** | [PAS-API-001-PLATFORM-API-CONTRACT-AUTHORITY-STANDARD.md](PAS-API-001-PLATFORM-API-CONTRACT-AUTHORITY-STANDARD.md) | Production Candidate (doctrine) | — |
| **PAS-API-REST-001** | [REST/PAS-API-REST-001](REST/PAS-API-REST-001-REST-OPENAPI-BINDING-STANDARD.md) | Active (scaffold) | [R3a–R3d](REST/SLICE/README.md) Planned |
