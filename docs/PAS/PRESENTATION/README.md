...
| Field | Value |
| --- | --- |
| **Scope** | Design layer — one Blueprint box · `@afenda/shadcn-studio-v2` |
...
| **Maturity** | **Enterprise Accepted** — PKGR05C active (ADR-0040 · Lane B-15) |
| **Last reviewed** | 2026-07-06 |

> **One sentence:** Five PAS documents govern frontend manufacturing doctrine, presentation product runtime, relational inventory & production pipeline, ACPA/WCAG acceptance, and metadata-driven surfaces — with slice handoffs in `PRESENTATION/SLICE/` and runtime in `@afenda/shadcn-studio-v2`.
...
Platform North Star
  ...
  → Code (packages/shadcn-studio-v2, apps/erp, apps/storybook, apps/developer)
```
...
| **PAS-006E** | [PAS-006E-DEVELOPER-ROUTE-LAB-STANDARD.md](PAS-006E-DEVELOPER-ROUTE-LAB-STANDARD.md) | Developer route lab — full-screen UX prototype · port 3002 | Delivered (P06-013–P06-016) | P06-013 **Delivered** · runtime authority [ADR-0044](../../adr/ADR-0044-developer-route-lab-runtime-authority-boundary.md) |

**Runtime authority today:** PAS-006 family P06-001–P06-016 + P06-008-R1/R2 delivered on `@afenda/shadcn-studio-v2` (Lane B-15 complete).
...
- Do not import `@afenda/kernel` into `@afenda/shadcn-studio-v2`.
- Do not restore `@afenda/ui`, appshell, metadata-ui, `@afenda/css-authority`, or `@afenda/shadcn-studio` (v1) without ADR.
