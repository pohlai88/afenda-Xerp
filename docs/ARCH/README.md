...
| [\[Complete\] ARCH-API-001-governed-rest-api.md](%5BComplete%5D%20ARCH-API-001-governed-rest-api.md) | PKG-007 · `@afenda/erp` | Governed REST API — `/api/internal/v1/**` · [`afenda-rest-api-governance.md`](../architecture/afenda-rest-api-governance.md) · **Complete — enterprise 9.5 accepted** |
