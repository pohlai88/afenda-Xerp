...
| **Status** | **Complete — enterprise 9.5 accepted** — slices 1–21 delivered; AUTH-PHASE3-001 **Closed** (Slice 13d · 2026-06-26) · DoD #15 closed (Slice 16 · 2026-06-26) · FR-A01.4 + FR-A05.3 closed (Slices 20–21 · 2026-06-26) |
| **Date** | 2026-06-25 |
...
5. docs/ARCH/[Complete] ARCH-AUTH-001-enterprise-authentication.md (this document)
...
Remaining gaps: **None blocking promotion** (Slice 17 · 2026-06-26).
**Carry-forward debt (non-blocking):** None — Slices 18–21 delivered 2026-06-26. Admin UI for company MFA override remains follow-up (Slice 21 scope excluded ERP UI).
```
...
| FR-A01.4 | Deactivate user revokes auth sessions | 20 ✓ |
...
| FR-A05.3 | Company workspace MFA override (`companies.mfa_required_override`) | 21 ✓ |
...
| ID | Requirement | Slice |
| --- | --- | --- |
| FR-A06.1 | Tenant-scoped IdP metadata (SAML/OIDC) persisted | 13a ✓ · 15 ✓ (SAML admin UI) |
...
| `auth.invitation.sent` | Phase 2 | Delivered (Slice 16) |
...
- docs/ARCH/[Complete] ARCH-AUTH-001-enterprise-authentication.md (status per slice)
...
Phase 3 — SSO / passkey / OAuth (13a–13d)     13a **Delivered** 2026-06-25 · 13b **Delivered** 2026-06-25 · 13c **Delivered** 2026-06-25 · 13d **Delivered** 2026-06-26
```
...
| 13c | Social OAuth allowlist + admin UI | **Delivered** 2026-06-25 | `@afenda/auth` · `apps/erp` |
| 13d | Phase 3 evidence-sync + Complete assessment | **Delivered** 2026-06-26 | docs only |
| 14 | `changeEmail` enabled + profile UI | **Delivered** 2026-06-25 | `@afenda/auth` · `apps/erp` |
| 15 | SAML admin UI + upsert (FR-A06.1) | **Delivered** 2026-06-26 | `@afenda/database` · `@afenda/auth` · `apps/erp` |
| 16 | DoD #15 RBAC attestation + invitation.sent audit | **Delivered** 2026-06-26 | `@afenda/auth` · `scripts/governance` · `apps/erp` |
| 17 | §16 promotion evidence-sync | **Delivered** 2026-06-26 | docs only |
...
| AC-02 | `authUserId` never in permission checks | `check:auth-user-id-rbac-boundary` + integration test | Delivered |
...
| 3 | Positive path tested | `packages/auth/src/__tests__/` | Delivered (132/132 pass · Slice 13d) |
| 4 | Negative path tested | invitation · MFA · unlinked tests | Delivered |
| 5 | TypeScript strict passes | typecheck exit 0 | Pass |
| 6 | Package tests pass | test:run exit 0 | **Delivered** — exit 0; 134/134 pass (Slice 16) |
...
| 15 | Security / RBAC verified | AC-02 · AC-05 · AC-06 | **Delivered** — Slice 16 gate exit 0 |
...
| 7 | Phase 3 SSO/passkey/OAuth via amendment slices 13a–13d | amendment accepted 2026-06-25 · 13a ✓ · 13b ✓ · 13a-debt ✓ · 13c ✓ · 13d ✓ (2026-06-26) |
...
| 10 | Enterprise readiness ≥ 29/30 | **97/100** §8 weighted — ≥95 attested Slice 13d |
...
| ~~AUTH-PHASE3-001~~ | ~~SSO · passkey · OAuth~~ | **Closed** Slice 13d — SSO (13a + 13a-debt) · passkeys (13b) · OAuth (13c) · evidence-sync (13d) | — |
...
```
Handoff from: docs/ARCH/[Complete] ARCH-AUTH-001-enterprise-authentication.md
...
**Remaining gaps (post–Slice 17):** ARCH promoted **Complete — enterprise 9.5 accepted**. Optional backlog: Slice 18–19.
