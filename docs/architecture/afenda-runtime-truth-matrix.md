...
| Field | Value |
|-------|-------|
| **As-of date** | 2026-06-29 (documentation-drift sync) |
...
| **Accounting Standards (PAS-003)** | `@afenda/accounting-standards` | `PKGR03_ACCOUNTING_STANDARDS` — Production Candidate (B0–B11 + B13–B16 ✓) | **partially-implemented** | IFRS pack + posting validation engine + 16 tests; B12 enterprise acceptance sync not started | B12 consumer workflow proof | [b12-11-enterprise-acceptance-sync.md](../PAS/ACCOUNTING-STANDARDS/SLICE/b12-11-enterprise-acceptance-sync.md) |
