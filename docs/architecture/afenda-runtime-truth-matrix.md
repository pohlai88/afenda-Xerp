...
| **Kernel ERP domain vocabulary catalog (PAS-001B)** | `packages/kernel/src/erp-domain/` · `accounting/` · `inventory/` · `procurement/` | PAS-001B B76–B80 ✓ · `PKGR01B_ERP_DOMAIN_CATALOG` | **partially-implemented** | 28-slug catalog; 3 delivered; 25 catalog-only; layout + domain gates green | B81+ per-module vocabulary | B81+ next module |
