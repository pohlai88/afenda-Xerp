...
| **Fingerprint** | `FOUNDATION-DISPOSITION-2026-06-30-v33` |
...
| PKGR05_PROCUREMENT | `@afenda/procurement` | amber-lane | no | Business procurement runtime deferred — features scaffold authorized ERP-PROC-OP-001; gap report sections B–F remain |
