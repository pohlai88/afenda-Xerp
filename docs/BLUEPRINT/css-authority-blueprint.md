...
| **Next document** | [PAS-005](../PAS/PAS-005-CSS-AUTHORITY-STANDARD.md) |
...
**Read order:** [Platform Constitutional Laws](../CONSTITUTION/platform-constitutional-laws.md) → [Platform NS](../architecture/afenda-platform-north-star.md) → [Domain NS §1–§12](../NORTHSTAR/css-authority-north-star.md) → **this document** → [PAS-005](../PAS/PAS-005-CSS-AUTHORITY-STANDARD.md) → Slice → Code.
...
- How **visual meaning → token → CSS** and theme hierarchy compose (§5.1 · §5.5)
...
| Domain North Star | §4 · §13 · §3.1–§3.3 · §12 E1–E7 | Box parent · taxonomy · theme |
...
| Cross-renderer mapping | **CSS authority** (future) | §15 — optional second representation |
...
| B3 | Domain NS §12 E1–E7 | T1 | Constitutional + implementation split | [`css-authority-north-star.md`](../NORTHSTAR/css-authority-north-star.md) |
| B4 | PAS-005 B26–B37 | T5 | 605-token registry · gates live | [`PAS-005`](../PAS/PAS-005-CSS-AUTHORITY-STANDARD.md) |
...
| --- | --- | --- | --- |
| **CSS authority** | Design token identity · taxonomy · theme layer placement · authority JSON sources · generator contract · `CSS-TOKEN-*` registry · vendored shadcn theme · Afenda extension CSS · namespace rules · consumption validation · CSS platform representation · strangler cutover vocabulary | Governed UI variant/recipe/state TS · React primitive behavior · AppShell block TSX · ERP business logic · accepted business term meaning · wire contracts · hand-edited generated registry · icons/illustrations (v1) | §4 · §9.1 · §9.2 |
...
| Cross-renderer mapping | New PAS + possible box rename | §3.3 · §15 | May unchanged | New representation gates | **Yes** |
...
> Maps Domain NS §3.1–§3.3 to PAS-005 authority domains inside **CSS authority**.
...
CSS authority (one box — multiple authority JSON domains)
        ...
        │     ├─ afenda-extensions.json    (platform base)
...
| Semantic token | Primitive token | references where possible | — | Metadata |
...
┌─────────────────────────────────────────────────────────────────────────────┐
│ BUSINESS AUTHORITY                                                           │
│ Design Token Authority North Star §1–§12 (meaning · taxonomy · theme · P9)   │
└───────────────────────────────────┬─────────────────────────────────────────┘
                                    ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│ ARCHITECTURAL MAP                                                            │
...
```text
Domain NS §3.1 taxonomy · §3.2 theme · §3.3 cross-platform model
        ↓
...
packages/css-authority/src/authorities/*.json (SSOT)
        ↓
generate:css-authority-registry → generated registry + CSS
        ↓
...
| Event | Update order |
| --- | --- |
| New design token | Domain NS category rules → authority JSON → regen → gates → consumers |
...
**Rule:** New representations map to **existing token identity** — they do not redefine visual meaning (I4).
...
- [ ] Domain NS §3.1 category on token
...
- [ ] §5.1 maps taxonomy · theme · authority domains
...
| PAS-005 | [`PAS-005-CSS-AUTHORITY-STANDARD.md`](../PAS/PAS-005-CSS-AUTHORITY-STANDARD.md) |
| PAS-005A | [`PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md`](../PAS/PAS-005A-SHADCN-STUDIO-PRESENTATION-STANDARD.md) |
| PAS-005B | [`PAS-005B-DESIGN-SYSTEM-RETIREMENT-STANDARD.md`](../PAS/PAS-005B-DESIGN-SYSTEM-RETIREMENT-STANDARD.md) |
...
Domain North Star owns **renderer-agnostic visual meaning** and theme hierarchy rules. PAS-005 owns **CSS representation contracts and gates**. Generated registry is **never** SSOT — authority JSON is.
