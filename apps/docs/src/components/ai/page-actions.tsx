...
import { resolveDocsPageActionsCopy } from "@/lib/docs-page-actions.copy";
...
export function MarkdownCopyButton({
  ...
  const t = resolveDocsPageActionsCopy(resolveLocaleFromPathname(usePathname()));
...
export function ViewOptionsPopover({
  ...
  const items = useMemo(() => {
    ...
    const q = t.readPrompt(String(pageUrl));
