...
export function HomeHero({ proofImageAlt }: HomeHeroProps) {
  return (
    <section className="relative isolate min-h-dvh overflow-hidden lg:h-dvh">
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-[5.2rem] left-[4vw] z-0 hidden select-none overflow-hidden font-semibold text-[clamp(8rem,16vw,15rem)] text-neutral-100/[0.09] leading-none tracking-[-0.08em] md:block"
      >
        PRESENTATION
      </div>
      ...
      <div className="relative z-10 mx-auto grid min-h-dvh w-full max-w-[1480px] grid-rows-[auto_1fr_auto] px-5 py-5 sm:px-8 lg:h-dvh lg:px-12">
        <header className="grid grid-cols-[1fr_auto] items-start gap-6 border-neutral-800/70 border-b pb-5">
          <div className="grid gap-1.5">
            ...
            <p className="ml-4 font-mono text-[0.5rem] text-neutral-600 uppercase tracking-[0.3em]">
              Afenda Proof Verification OS
            </p>
          </div>

          <div className="flex items-center gap-5 font-mono text-[0.5rem] text-neutral-600 uppercase tracking-[0.28em]">
            ...
            />
            <a
              aria-label="Jump to the proof chamber"
              className="rounded-sm text-neutral-500 transition-colors duration-300 hover:text-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              href="#proof"
            >
              Enter
            </a>
        ...
        <div className="relative grid min-h-0 items-center gap-7 py-8 md:grid-cols-[minmax(0,1fr)_minmax(22rem,0.82fr)] lg:gap-12 lg:py-7">
          {metadataRails.map((rail) => (
            <p
              className={[
                "pointer-events-none absolute hidden font-mono text-[0.48rem] text-neutral-600 uppercase tracking-[0.36em] md:block",
                rail.position === "left"
          ...
          <div className="max-w-[45rem] pt-2 md:pl-8">
            <p className="mb-8 font-mono text-[0.58rem] text-neutral-300/70 uppercase tracking-[0.48em]">
              Afenda Shadcn/Studio
            </p>

            <h1 className="font-semibold text-[#f3efe4] text-[clamp(5.6rem,11.4vw,11.2rem)] leading-[0.72] tracking-[-0.08em]">
              LAB
            </h1>

            <a
              className="mt-7 inline-flex items-center gap-5 rounded-sm font-mono text-[0.48rem] text-neutral-600 uppercase tracking-[0.42em] transition-colors duration-300 hover:text-violet-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              href="#phase-02"
            >
          ...
          <aside
            className="relative mx-auto flex w-full max-w-[24rem] justify-center md:max-w-[28rem] md:-translate-y-3"
            id="proof"
          >
            <div
              aria-hidden="true"
            ...
            <figure className="relative aspect-[3/4] w-[min(76vw,22rem)] bg-[#020202] p-2.5 shadow-[0_34px_90px_-35px_rgba(0,0,0,1),0_0_52px_-34px_rgba(139,92,246,0.72)] outline outline-1 outline-neutral-800/75">
              ...
              <div className="group relative h-full overflow-hidden border border-neutral-800/55 bg-[#050505]">
                ...
                <figcaption className="absolute top-5 left-5 font-mono text-[0.48rem] text-neutral-300/38 uppercase tracking-[0.36em]">
                  Fig 1.0
                </figcaption>
                <p className="absolute right-5 bottom-5 font-mono text-[0.48rem] text-neutral-300/38 uppercase tracking-[0.36em]">
                  Sealed
                </p>
        ...
        <footer className="grid grid-cols-[1fr_auto] items-end gap-6 border-neutral-800/70 border-t pt-5 font-mono text-[0.5rem] text-neutral-600 uppercase tracking-[0.28em]">
