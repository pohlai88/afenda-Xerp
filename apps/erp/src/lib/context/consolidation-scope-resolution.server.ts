...
import { mergeInvesteeConsolidationScopeEntry } from "./consolidation-scope-investee-merge.policy";
...
/**
 * Governed non-accounting consolidation scope derivation (PAS-001A / Blueprint §6).
