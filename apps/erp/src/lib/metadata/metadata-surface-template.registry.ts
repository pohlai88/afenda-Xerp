/** ERP-local PAS-006D surface template registry (B-08 v2 bridge). */

import { WORKFLOW_BOARD_MANIFEST_DECISION } from "@afenda/shadcn-studio-v2/metadata";

import type { SurfaceTemplateContractWire } from "./metadata-studio.contract";

export const METADATA_SURFACE_TEMPLATE_AUTHORITY = {
  lane: WORKFLOW_BOARD_MANIFEST_DECISION.lane,
  registryOwner: "apps/erp/src/lib/metadata",
} as const;
    ...
    blockBindings: [
      {
        ...
        slotFills: {
          ...
          "auth-complete.title": "auth-complete.title",
          "auth-complete.description": "auth-complete.description",
          "auth-complete.status": "auth-complete.status",
        },
      },
    ],
