...
const PRESENTATION_ATOM_REF_TO_LABEL = {
  ...
  "atom.auth.register-branding-lead":
    "Use your approved workspace invitation to join a governed operator environment.",
  "atom.auth.register-branding-title": "Create your Afenda ERP account",
  "atom.auth.register-confirm-password": "Confirm password",
  "atom.auth.register-email": "Work email",
  "atom.auth.register-eyebrow": "Invitation onboarding",
  "atom.auth.register-form-subtitle":
    "Create credentials for the workspace your team approved.",
  "atom.auth.register-form-title": "Accept your invitation",
  "atom.auth.register-invitation-code": "Invitation or workspace code",
  "atom.auth.register-name": "Full name",
  "atom.auth.register-password": "Password",
  "atom.auth.register-submit": "Create account",
