import { systemAdminMembershipRoleAssignmentsPostContract } from "@/server/api/contracts/system-admin/system-admin.contract";
...
export const POST = createApiHandler({
  contract: systemAdminMembershipRoleAssignmentsPostContract,
