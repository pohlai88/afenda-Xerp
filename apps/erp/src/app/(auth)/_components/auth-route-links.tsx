...
const AUTH_ROUTE_LINKS: Partial<
  Record<AuthEntryRouteId, readonly AuthRouteLink[]>
> = {
  signUp: [
    {
  ...
  forgotPassword: [{ href: buildAuthPath("signIn"), label: "Back to sign in" }],
  resetPassword: [
    {
  ...
  verifyEmail: [{ href: buildAuthPath("signIn"), label: "Return to sign in" }],
  verifyEmailSent: [
  ...
  accessDenied: [{ href: buildAuthPath("signIn"), label: "Return to sign in" }],
...
export function AuthRouteLinks({
  route,
}: {
