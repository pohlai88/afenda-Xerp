...
export type SignUpFormGovernedComponents = Extract<
      ...
      <AuthForm.Fields onSubmit={handleSubmit}>
        <div className="erp-auth-form__field">
          ...
          <Input
            ...
            value={name}
          />
          <p className="erp-auth-form__field-hint">{SIGN_UP_NAME_HINT}</p>
        </div>
        <div className="erp-auth-form__field">
          ...
          <Input
            ...
            value={email}
          />
          <p className="erp-auth-form__field-hint">{SIGN_UP_EMAIL_HINT}</p>
        </div>
        <div className="erp-auth-form__field">
          ...
          <Input
            ...
            value={password}
          />
          <p className="erp-auth-form__field-hint">{SIGN_UP_PASSWORD_HINT}</p>
        </div>
