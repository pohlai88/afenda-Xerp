...
export const metadata: Metadata = AUTH_V2_ROUTE_REGISTRY.mfaRecovery.metadata;

export default async function AuthV2MfaRecoveryPage() {
  const initialPayload = await readMfaChallengeCookie();

  return (
    <AuthV2EntryPage route="mfaRecovery">
