...
| Developer (route lab) | 3002 | **ERP-parity** operator UX — same page law as production · auth/spine/BFF **only** exclusions · [ADR-0039](../../../docs/adr/ADR-0039-developer-presentation-sandbox.md) · [ADR-0044](../../../docs/adr/ADR-0044-developer-route-lab-runtime-authority-boundary.md) |
...
- **Route lab:** wiring live auth, `@afenda/kernel`, or `api/internal/v1` BFF — [ADR-0044](../../../docs/adr/ADR-0044-developer-route-lab-runtime-authority-boundary.md); promote to `apps/erp` instead
