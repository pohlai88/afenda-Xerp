---
name: platform-cross-boundary-anti-pattern-scan
...
```text
/platform-cross-boundary-anti-pattern-scan @afenda/kernel
/platform-cross-boundary-anti-pattern-scan packages/metadata
/platform-cross-boundary-anti-pattern-scan apps/erp auth-v2
/platform-cross-boundary-anti-pattern-scan find anti-patterns import gates miss
```
...
Read-only scan complete when output includes all five sections (Executive verdict, Anti-pattern matrix, Blind-spot report, Top three priorities, Confidence matrix).

Optional gate after remediation (implementation mode only):
