...
| UI components | `packages/shadcn-studio-v2/src/components/`, `@afenda/shadcn-studio-v2` tests |
| AppShell blocks | removed — ADR-0027; use `packages/shadcn-studio-v2/src/views/` |
